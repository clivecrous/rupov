...
scene << PointLight.new( Vector.new( [10,30,10] ), Colour.new( "White" ) )
scene << PointLight.new( Vector.new( [0,30,10] ), Colour.new( "White" ) )

ground = Plane.new( Vector.new( [0,1,0] ), 0 )
ground << Pigments::SolidColour.new( ColourRGB.new( [0.6,0.4,0] ) )
