...
(0...720).each do |deg|
    degrees = deg*4
    sphere = Sphere.new( Povray::DataTypes::Vector::XYZ.new( degrees/100.0-12.5, 1+radius*Math::cos(Math::PI*degrees/180.0), 2+radius*Math::sin(Math::PI*degrees/180.0)), (radius.abs)/20)
...
disc = Cylinder.new( Povray::DataTypes::Vector::XYZ.new( 0,0,0 ), Povray::DataTypes::Vector::XYZ.new( 0,0.1,0 ), 20 )
